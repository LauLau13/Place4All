...
namespace WebApi.Servicios
{
    public class RestauranteServicio
    {
        ...
        public Task<List<Restaurante>> Search(IBuscaCiudad busqueda) => _restaurantes.Find(restaurante => restaurante.Direccion.Ciudad.ToLower() == busqueda.Ciudad.ToLower()).ToListAsync();
